...
wget --no-check-certificate  -O /tmp/frps/frps.zip https://raw.githubusercontent.com/yxwmok/tool/main/frps_install/frps.zip && unzip -o /tmp/frps/frps.zip -d /tmp/frps
